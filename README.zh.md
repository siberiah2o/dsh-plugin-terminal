...
[English](README.md) · [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
...
| pnpm 提示 `Ignored build scripts: node-pty` | 在 profile 的 `pnpm-workspace.yaml` 声明 `onlyBuiltDependencies`（见安装说明）后重跑安装 |
